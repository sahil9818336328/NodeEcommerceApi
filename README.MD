...
[E-Commerce API Heroku URL](https://e-commerce-api-node-express.herokuapp.com/)
...
- [] setup .env with MONGO_URI, JWT_SECRET, JWT_LIFETIME, STRIPE_CLIENT_SECRET variable and assign the values
...
#### Aggregation Pipeline - Atlas(GUI) and Code(CUSTOM-CODE)
